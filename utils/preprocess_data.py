# References: Official Cityscapes Scripts, https://github.com/fregu856/deeplabv3
import pickle
import numpy as np
import cv2
import os
...
cityscapes_data_path = sys.argv[1]
...
cityscapes_meta_path = cityscapes_data_path + "/meta"
...
for train_dir in train_dirs:
    ...
    train_image_path = image_dir + train_dir
    train_label_path = label_dir + train_dir
...
image_dir = cityscapes_data_path + "/leftImg8bit/val/"
label_dir = cityscapes_data_path + "/gtFine/val/"

for val_dir in val_dirs:

    val_image_dir_path = image_dir + val_dir
    val_label_dir_path = label_dir + val_dir

    file_names = os.listdir(val_image_dir_path)
